...
public class AppModule
{
	...
	public static void contributeFactoryDefaults(MappedConfiguration<String, Object> configuration)
	{
		...
		// default values for gmail smtp server
		// these can be overridden in the application module
		// additionally add configuration entries for PlannowSecuritySymbols.MAIL_ADDRESS,
		// PlannowSecuritySymbols.MAIL_USERNAME and PlannowSecuritySymbols.MAIL_PASSWORD
	...
	@Startup
	public void startupMethod(@Symbol(PlannowSecuritySymbols.MAIL_ADDRESS) String mailAddress)
	{
